...
@section('content')
    ...
    <main class="app-content">
        ...
        <div class="">
            <a class="btn btn-primary" href="{{route('customers.create')}}"><i class="fa fa-plus"></i> Add New Customer</a>
        </div>
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tr>
                                ...
                                <td>{{ $customer->details }} </td>
                                 <td>
                                    <a class="btn btn-primary btn-sm" href="{{route('customers.edit', $customer->id)}}"><i class="fa fa-edit" ></i></a>
