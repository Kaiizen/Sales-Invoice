    ...
    <div class="tile-body">
        <div class="row">
            <div class="form-group col-md-6">
                <div class="form-check">
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" name="is_fabric" value="1" {{ old('is_fabric') ? 'checked' : '' }}>
            ...
            <div class="form-group col-md-6">
                <div class="form-check">
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" name="track_by_roll" value="1" {{ old('track_by_roll') ? 'checked' : '' }}>
        ...
        <div id="fabric-fields" class="{{ old('is_fabric') ? '' : 'd-none' }}">

            <div class="row">
                <div class="form-group col-md-6">
                    <label class="control-label">Total Square Feet</label>
                    <input value="{{ old('total_square_feet', 0) }}" name="total_square_feet" class="form-control" type="number" step="0.01" placeholder="Total square feet available">
                </div>
                <div class="form-group col-md-6">
...
<div id="add-roll-section" class="{{ (old('is_fabric') && old('track_by_roll')) ? '' : 'd-none' }}">
    <div class="tile">
        <h3 class="tile-title">Add Initial Fabric Roll</h3>
        <div class="tile-body">
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input name="number_of_rolls" value="{{ old('number_of_rolls', 1) }}" class="form-control" type="number" min="1" step="1" placeholder="Number of rolls">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="add_new_roll" value="1" {{ old('add_new_roll') ? 'checked' : '' }}>
